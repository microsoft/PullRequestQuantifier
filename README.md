...
- Quantify your PR accurately: exclude files that are not necessary 
   to be reviewed or do not increase the review complexity. Example: autogenerated code, docs, project IDE setting files, binaries, etc.
   Check out the "Excluded" section from your ".prquantifier" file.
